...
class TableMixin:
    ...
    def _log_study_tables(all_trials, pareto_front, prefix="study", step=None):
        ...
        for trial in all_trials:
            config_id_value = trial.get('config_id', WandBUtils.get_config_id(trial.get('config', {})))
            if isinstance(config_id_value, (int, float)):
                config_id_value = str(config_id_value)
        ...
        for trial in best_configs:
            config_id_value = trial.get('config_id')
            if isinstance(config_id_value, (int, float)):
                config_id_value = str(config_id_value)
