...
class PipelineOrchestrator:
    def __init__(self, component_runners, evaluator, config_generator, 
                 intermediate_handler=None, use_ragas=False, 
                 retrieval_weight=0.5, generation_weight=0.5):
        ...
        self.generation_metrics = getattr(evaluator, 'generation_metrics', [])
    ...
    def execute_full_pipeline(self, config: Dict[str, Any], trial_dir: str, 
        ...
        try:
            ...
            if save_intermediate and query_expansion_results and self.intermediate_handler:
            ...
            if eval_df is not None:
                generation_results = self.evaluate_generation_traditional(eval_df, qa_subset)
                if save_intermediate and self.intermediate_handler:
