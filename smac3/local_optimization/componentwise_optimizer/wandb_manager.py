...
class WandBManager:
    ...
    def init_for_component(self, component: str, component_idx: int, total_components: int):
    ...
    def log_component_summary(self, component: str, component_result: Dict[str, Any]):
        try:
    ...
    def log_component_table(self, component: str):
    ...
    def log_final_summary(self, all_results: Dict[str, Any]):
        if wandb.run is not None:
            try:
                wandb.finish()
            except Exception as e:
