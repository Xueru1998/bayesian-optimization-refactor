...
class ParameterExtractor:
    ...
    def extract_query_expansion_params(self) -> Dict[str, Any]:
        params = {}
    ...
    def extract_retrieval_params(self) -> Dict[str, Any]:
        params = {}
    ...
    def extract_reranker_params(self) -> Dict[str, Any]:
        params = {}
    ...
    def extract_filter_params(self) -> Dict[str, Any]:
        params = {}
    ...
    def extract_compressor_params(self) -> Dict[str, Any]:
        params = {}
    ...
    def extract_prompt_maker_params(self) -> Dict[str, Any]:
        params = {}
    ...
    def extract_generator_params(self) -> Dict[str, Any]:
        params = {}
